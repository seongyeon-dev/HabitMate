...
if (totalChallenges > 0) {
  completionRate = Math.round((completedCount / totalChallenges) * 100);
}
...
/* 총 참여 챌린지 표시 */
statisticItems[0].querySelector("strong").innerHTML =
  totalChallenges + "<span>개</span>";

/* 완료한 챌린지 표시 */
statisticItems[1].querySelector("strong").innerHTML =
  completedCount + "<span>개</span>";

/* 완주율 표시 */
statisticItems[2].querySelector("strong").innerHTML =
  completionRate + "<span>%</span>";

/* 현재 연속 성공 표시 */
statisticItems[3].querySelector("strong").innerHTML =
  streak + "<span>일</span>";

/* 최고 연속 성공 표시 */
statisticItems[3].querySelector("small").innerText = "최고 " + maxStreak + "일";
