...
/* 챌린지 정보 */
    ...
    const challengeDescription = document.querySelectorAll(".challenge-text p")[0];
    ...
    /* 실패 기록 */
    summaryItems[1].querySelector("strong").innerText =
        failDays + "일";
    ...
    const weightChange = changeCards[0].querySelector(
        ".change-value > strong"
    );
